...
function calendario() {
    // meuCalendario.style.border = '2px solid black';
    meuCalendario.style.borderRadius = '20px';
  meuCalendario.style.backgroundColor = '#ced4da';
  
  meuNutri.style.borderRadius = '20px';
  meuNutri.style.backgroundColor = '#fff';
content.innerHTML = `
<div class="container">
<div class="left">
<div class="calendar">
...
function nutri() {
  meuCalendario.style.borderRadius = '20px';
  meuCalendario.style.backgroundColor = '#fff';

  meuNutri.style.borderRadius = '20px';
  meuNutri.style.backgroundColor = '#ced4da';
